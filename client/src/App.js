...
//     await contract.methods.set(44).send({ from: accounts[0] });
...
//     return (
//       <div className="App">
//         <h1>This is Truffle-React-Template!</h1>
...
class App extends Component {
  ...
  async handleSubmit(event) {
    ...
    //const result = await contract.methods.set(this.state.newValue, {from: accounts[0]});
    const response = await contract.methods.get().call();
    this.setState({storageValue: response });
